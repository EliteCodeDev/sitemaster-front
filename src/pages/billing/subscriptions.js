        ...
        <>
            ...
            <div>
                ...
                <a
                    ...
                    className="inline-flex items-center px-6 py-2 bg-[var(--app-primary)] text-white font-semibold rounded-lg shadow-md hover:bg-[var(--app-primary-hovered)] focus:outline-none focus:ring-2 focus:ring-[var(--app-primary)] transition duration-200"
                >
